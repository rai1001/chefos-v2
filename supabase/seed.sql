...
values (
  '99999999-1111-1111-1111-999999999900',
  '11111111-1111-1111-1111-111111111111',
  '22222222-2222-2222-2222-222222222222',
  '66666666-0000-0000-0000-000000000020',
  'draft'
...
insert into production_tasks (id, org_id, hotel_id, plan_id, title, status, station, priority)
values
  ('99999999-1111-1111-1111-999999999901', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '99999999-1111-1111-1111-999999999900', 'Picar verduras', 'draft', 'Prep', 1),
  ('99999999-1111-1111-1111-999999999902', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '99999999-1111-1111-1111-999999999900', 'Salsa base', 'in_progress', 'Cocina', 2),
  ('99999999-1111-1111-1111-999999999903', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '99999999-1111-1111-1111-999999999900', 'Montar postre', 'done', 'Pastry', 3)
on conflict (id) do nothing;

insert into stock_levels (id, org_id, location_id, supplier_item_id, on_hand, available_on_hand, consider_reservations)
values
  ('99999999-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', '88888888-0000-0000-0000-000000000001', '77777777-0000-0000-0000-000000000011', 20, 20, true),
  ('99999999-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', '88888888-0000-0000-0000-000000000001', '77777777-0000-0000-0000-000000000012', 12, 12, true),
  ('99999999-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', '88888888-0000-0000-0000-000000000002', '77777777-0000-0000-0000-000000000013', 6, 6, false)
on conflict (id) do nothing;
