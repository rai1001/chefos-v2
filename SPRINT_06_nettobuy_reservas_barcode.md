...
- [x] Migraciones: stock_levels + reservations + product_barcodes.
- [x] RLS: políticas y tests por tabla.
- [x] UI básica: net-to-buy en detalle de pedido + asignación de barcode.
- [x] Tests: DB (available_on_hand), integration, E2E mínimo.
- [x] Docs: decisión de “reservas no descuentan on_hand”.
...
- [x] RPC/trigger para recalcular `available_on_hand` (al crear/cancelar reservas).
...
### Auth / permisos
- [x] Purchasing/Admin: editar pedidos + asignar barcodes.
- [x] Chef/Kitchen: crear/gestionar reservas (o al menos lectura) según necesidad.
...
### Docs / inventory
- [x] `docs/inventory/060_sprint06.md`:
  - modelo de reservas
